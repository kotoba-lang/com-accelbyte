(ns run-tests
  ...
  test namespaces:
    ...
    accelbyte.main-test  (.cljc) -- portable, listed below
    accelbyte.kotoba-qualification-test  (.clj) -- JVM-only, NOT listed

  The qualification namespace requires kotoba.compiler.core, kotoba.runtime
  and kotoba.wasm-exec to compile src/accelbyte/page_limit.kotoba and execute it on
...
(t/run-tests 'accelbyte.main-test)
